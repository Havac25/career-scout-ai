...
# ==============================================================================
# Career Scout AI - Local Linux Setup Script
# ==============================================================================
# Run this script on your Linux PC from the project root directory:
...
echo "======================================================"
echo "Career Scout AI - Local Linux Setup Script"
echo "======================================================"

echo ""
echo "1. Installing system dependencies (requires sudo)..."
sudo dnf update -y
sudo dnf install -y git curl python3-pip python3-devel rsync
